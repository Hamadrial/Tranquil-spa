    ...
    <div class="row">
      <div class="col-sm-6 address well">
        <address class="spa-address">
          <p><i class="fa fa-map-marker"></i><?php _e( 'Tranquil Spa' ); ?></p>

          <p class="no-margin-bottom"><?php _e( 'Address line 1' ); ?></p>
          <p class="no-margin-bottom"><?php _e( 'Address line 2' ); ?></p>
          <p class="no-margin-bottom"><?php _e( 'Address line 3' ); ?></p>
        </address>
